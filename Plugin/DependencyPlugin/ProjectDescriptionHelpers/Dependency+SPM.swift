...
public extension Package {
  struct SPM {
    ...
    public static let ComposableArchitecture: Package = .remote(url: "https://github.com/pointfreeco/swift-composable-architecture", requirement: .upToNextMajor(from: "1.7.0"))
